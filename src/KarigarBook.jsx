...
const styles = {
  ...
  tab: { padding: "4px 8px", borderRadius: 6, border: `1px solid ${C.border}`, background: C.navyL, color: C.muted, fontSize: 11, whiteSpace: "nowrap", cursor: "pointer" },
  tabActive: { padding: "4px 8px", borderRadius: 6, border: `1px solid ${C.gold}`, background: C.gold, color: C.navy, fontSize: 11, fontWeight: 600, whiteSpace: "nowrap", cursor: "pointer" },
